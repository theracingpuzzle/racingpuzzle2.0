// ─── RACING API ─── theracingapi.com integration
...
async function testRacingAPI(){
  ...
  for(const t of tests){
    try{
      const resp=await fetch('/.netlify/functions/api',{method:'POST',headers:{'Content-Type':'application/json'},
